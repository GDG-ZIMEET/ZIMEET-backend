...
public enum Code implements BaseCode {
    ...
    PROFILE_ALREADY_VISIBLE(HttpStatus.BAD_REQUEST, "MEETING4015", "이미 1대1 미팅에 참여했습니다."),
    PROFILE_ALREADY_INVISIBLE(HttpStatus.BAD_REQUEST, "MEETING4016", "이미 1대1 미팅을 취소했습니다."),
